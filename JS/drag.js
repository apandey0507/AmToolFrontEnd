(function () {
  ...
  //related letiable is needed to maintain a reference to the
  //dragleave's relatedTarget, since it doesn't have e.relatedTarget
  let related = null;

  //dragenter event to set that letiable
  document.addEventListener(
    'dragenter',
    function (e) {
      related = e.target;
  ...
  //dragleave event to maintain target highlighting using that letiable
  document.addEventListener(
    'dragleave',
    function (e) {
